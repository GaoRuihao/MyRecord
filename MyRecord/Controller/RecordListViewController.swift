...
class RecordListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        navigationController?.setTransparentNavigationBarStyle()
        buildSubviews()
    ...
    func buildSubviews() {        
        ...
        let rightItem = UIBarButtonItem(image: UIImage(named: "calendar"), style: .plain, target: self, action: #selector(rightItemAction(_:)))
